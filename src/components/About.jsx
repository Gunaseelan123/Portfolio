    ...
    <div id="about" className="bg-[#222831] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <p data-aos="fade-up" data-aos-duration="300" className="text-lg md:text-xl text-gray-300 text-center leading-relaxed">
          I’m <span className="font-bold text-[#00ADB5]">Gunaseelan</span>,
          a React.js and MERN stack developer passionate about creating responsive and dynamic web applications. With strong expertise in <span className="font-bold text-[#00ADB5]">React.js</span>  and hands-on experience with the full <span className="font-bold text-[#00ADB5]">MERN stack</span>, I specialize in building scalable and efficient solutions. I’ve worked on several real-world projects, focusing on delivering high-quality, user-friendly web experiences. Constantly learning and growing, I strive to create impactful solutions that solve real-world problems.
        </p>
