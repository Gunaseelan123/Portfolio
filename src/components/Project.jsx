    ...
    <div id="project" className="bg-[#222831] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <div data-aos="fade-up" className="w-full md:w-1/2 flex flex-col items-center bg-[#393E46] p-6 rounded-2xl shadow-lg">
          <h1 className="text-[#00ADB5] font-extrabold text-[32px] mb-4 text-center">
            Expertisor Academy
          </h1>
          ...
          <a
            ...
            className="text-[#00ADB5] font-bold text-lg hover:underline text-center"
          >
            Live Demo
          </a>
        </div>
        ...
        <div data-aos="fade-up" className="w-full md:w-1/2 flex flex-col place-self-end bg-[#393E46] p-6 rounded-2xl shadow-lg">
          <h1 className="text-[#00ADB5] text-center font-extrabold text-[32px] mb-4">
            Furniture E-Com
          </h1>
          <p className="text-lg text-[#fff] mb-4 ">
Built a responsive furniture e-commerce website using the MERN stack and Tailwind CSS, featuring product listings, cart functionality, and order processing, with a focus on clean UI and smooth user experience.          </p>
          <a
            href="https://e-commercee-furnitures.onrender.com"
